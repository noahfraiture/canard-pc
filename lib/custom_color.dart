...
const customcolor1 = Color(0xFFED1B25);


CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFFED1B25),
  customcolor1: Color(0xFFC00015),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFFFFDAD6),
  onCustomcolor1Container: Color(0xFF410002),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFFED1B25),
  customcolor1: Color(0xFFFFB4AC),
  onCustomcolor1: Color(0xFF690007),
  customcolor1Container: Color(0xFF93000E),
  onCustomcolor1Container: Color(0xFFFFDAD6),
);
